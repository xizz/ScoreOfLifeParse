...
public class ParseLoginBuilder {
	 ...
	 *
	 * @param id The resource ID for the logo drawable.
	 ...
	 *
	 * @param enabled Whether to show the username/password login.
	 * @return The caller instance to allow chaining.
	 */
	 ...
	 * Customize the text of the Parse username/password login button.
	 *
	 * @param id The resource ID for the text to display on the login button.
	 * @return The caller instance to allow chaining.
	 */
	 ...
	 * Customize the text on the Parse signup button.
	 *
	 * @param id The resource ID for the text to display on the button.
	 * @return The caller instance to allow chaining.
	 */
	 ...
	 * Customize the text for the link to resetting the user's forgotten password.
	 *
	 * @param id The resource ID for the text to display on the link.
	 * @return The caller instance to allow chaining.
	 */
	 ...
	 * pair.
	 *
	 * @param id The resource ID for the text to display on the toast.
	 * @return The caller instance to allow chaining.
	 */
	 ...
	 *
	 * @param emailAsUsername Whether to use email as the user's username in the Parse SDK.
	 * @return The caller instance to allow chaining.
	 */
	 ...
	 *
	 * @param minPasswordLength The minimum required password length for signups
	 * @return The caller instance to allow chaining.
	 */
	 ...
	 *
	 * @param text The text to display on the user signup submission button.
	 * @return The caller instance to allow chaining.
	 */
	 ...
	 * is only shown if you enable Parse username/password login.
	 *
	 * @param id The resource ID fo the text to display on the user signup
	 *           submission button.
	 * @return The caller instance to allow chaining.
	 */
	 ...
	 * false.
	 *
	 * @param enabled Whether to show the facebook login.
	 * @return The caller instance to allow chaining.
	 */
	 ...
	 *
	 * @param text The text to display on the Facebook login button.
	 * @return The caller instance to allow chaining.
	 */
	 ...
	 * Customize the text on the Facebook login button.
	 *
	 * @param id The resource ID for the text to display on the Facebook login
	 *           button.
	 * @return The caller instance to allow chaining.
	 */
	 ...
	 *
	 * @param permissions The Facebook permissions being requested.
	 * @return The caller instance to allow chaining.
	 */
	 ...
	 * false.
	 *
	 * @param enabled Whether to show the Twitter login.
	 * @return The caller instance to allow chaining.
	 */
	 ...
	 *
	 * @param loginButtonText The text to display on the Twitter login button.
	 * @return The caller instance to allow chaining.
	 */
	 ...
	 * Customize the text on the Twitter login button.
	 *
	 * @param id The text to display on the Twitter login button.
	 * @return The caller instance to allow chaining.
	 */
